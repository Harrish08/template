                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <td><button type="button" class="btn btn-danger" style="font-weight:bold;">Pending</button></td>
                                                    <?php
                                                    }
                                                    if ($status == "confirmed") { ?>
                                                        <td><button type="button" class="btn btn-primary"><span class="fa fa-cog fa-refresh" aria-hidden="true"></span>Confirmed</button></td>
                                                    <?php
                                                    }
                                                    ...
                                                    if ($status == "out for delivery") { ?>
                                                        <td><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-thumbs-o-up" aria-hidden="true"></span>Out for Delivery!</button></td>
                                                    <?php
                                                    }
                                                    if ($status == "closed") {
                                                    ?>
