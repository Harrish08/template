                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']); ?>&oid=<?php echo htmlentities($rows['o_id']); ?>');" title="Update order">
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <center><button type="button" class="btn btn-info" style="font-weight:bold;"><span class="fa fa-bars" aria-hidden="true">Pending</button></center>
                                                    </td>
                                                <?php
                                                }
                                                ...
                                                if ($status == "confirmed") {
                                                    ?>
                                                        <td>
                                                        <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span>Confirmed</button></center>
                                                        </td>
                                                    <?php
                                                    }
                                                ...
                                                if ($status == "out for delivery") {
                                                    ?>
                                                        <td>
                                                        <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span>Out for Delivery</button></center>
                                                        </td>
                                                    <?php
                                                    }
