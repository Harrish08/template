                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td data-column="status">
                                                            ...
                                                            if ($status == "confirmed") { ?>
                                                                <button type="button" class="btn btn-primary"><span class="fa fa-cog fa-refresh" aria-hidden="true"></span>Confirmed</button>
                                                            <?php
                                                            }
                                                            ...
                                                            if ($status == "out for delivery") { ?>
                                                                <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-thumbs-o-up" aria-hidden="true"></span> Out for Delivery!</button>
                                                            <?php
                                                            }
                                                            if ($status == "closed") {
                                                            ?>
                                                        ...
                                                        {
                                                        $query= mysqli_query($db, "select * from remark where o_id='" . $row['o_id'] . "'");
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/food-picky-logo.png" alt="Footer logo"> </a> <span>Download  &amp; Template </span>
                    </div>
